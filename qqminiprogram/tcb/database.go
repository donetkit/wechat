...
const (
	//数据库导入
	databaseMigrateImportURL = "https://api.q.qq.com/tcb/databasemigrateimport"
	//数据库导出
	databaseMigrateExportURL = "https://api.q.qq.com/tcb/databasemigrateexport"
	//数据库迁移状态查询
	databaseMigrateQueryInfoURL = "https://api.q.qq.com/tcb/databasemigratequeryinfo"
	//变更数据库索引
	updateIndexURL = "https://api.q.qq.com/tcb/updateindex"
	//新增集合
	databaseCollectionAddURL = "https://api.q.qq.com/tcb/databasecollectionadd"
	//删除集合
	databaseCollectionDeleteURL = "https://api.q.qq.com/tcb/databasecollectiondelete"
	//获取特定云环境下集合信息
	databaseCollectionGetURL = "https://api.q.qq.com/tcb/databasecollectionget"
	//数据库插入记录
	databaseAddURL = "https://api.q.qq.com/tcb/databaseadd"
	//数据库删除记录
	databaseDeleteURL = "https://api.q.qq.com/tcb/databasedelete"
	//数据库更新记录
	databaseUpdateURL = "https://api.q.qq.com/tcb/databaseupdate"
	//数据库查询记录
	databaseQueryURL = "https://api.q.qq.com/tcb/databasequery"
	//统计集合记录数或统计查询语句对应的结果记录数
	databaseCountURL = "https://api.q.qq.com/tcb/databasecount"
