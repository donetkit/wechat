...
const (
	//获取文件上传链接
	uploadFilePathURL = "https://api.q.qq.com/tcb/uploadfile"
	//获取文件下载链接
	batchDownloadFileURL = "https://api.q.qq.com/tcb/batchdownloadfile"
	//删除文件链接
	batchDeleteFileURL = "https://api.q.qq.com/tcb/batchdeletefile"
)
